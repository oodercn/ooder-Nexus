package net.ooder.nexus.adapter.inbound.controller.end;
...
import net.ooder.nexus.domain.end.model.EndAgentListResult;
import net.ooder.nexus.domain.end.model.EndAgentDetailResult;
import net.ooder.nexus.domain.end.model.EndAgentDeleteResult;
import net.ooder.nexus.domain.end.model.EndAgentDiscoverResult;
import net.ooder.nexus.domain.end.model.EndAgentDiscoveryStatusResult;
import net.ooder.nexus.domain.end.model.EndAgentStatsResult;
